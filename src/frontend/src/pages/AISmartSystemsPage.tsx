...
import { AlertTriangle, Bot, Copy, Download, Loader2 } from "lucide-react";
...
const tools: Tool[] = [
  {
    ...
    description:
      "Get AI-powered service recommendations based on client needs.",
    fields: [
      {
        key: "business",
        label: "Business Type",
        placeholder: "e.g. E-commerce startup, Restaurant chain",
      },
    ...
    buildPrompt: (i) =>
      `You are a digital agency consultant. Recommend the best services for this client:\nBusiness: ${i.business}\nBudget: ${i.budget}\nGoals: ${i.goals}\n\nProvide 3-5 specific service recommendations with rationale and estimated ROI.`,
  },
  {
    id: "proposal",
    ...
    fields: [
      {
        ...
        placeholder: "Paste lead details, conversation notes, etc.",
        multiline: true,
      },
      {
        key: "service",
...
function ToolPanel({ tool }: { tool: Tool }) {
      ...
      const result = await callAI(tool.name, [
        {
          role: "system",
          content:
            "You are an expert AI agency consultant for Quick Bee AI Growth Engine. Provide detailed, actionable, professional responses.",
        },
  ...
  return (
    <div className="glass-card rounded-xl p-5">
      ...
      <p className="text-xs mb-4" style={{ color: "rgba(232,245,244,0.5)" }}>
        {tool.description}
      </p>
      ...
      <Button
        ...
        className="w-full btn-teal mb-4"
      >
        {loading ? (
          <>
      ...
      {output && (
        <div>
          ...
          <div
            className="code-block whitespace-pre-wrap text-xs max-h-64 overflow-y-auto"
            style={{ color: "#e8f5f4", background: "rgba(0,0,0,0.3)" }}
          >
            {output}
          </div>
        </div>
    ...
    <div className="space-y-6">
      <div className="page-header">
        <div className="flex items-center gap-3">
          <img
            src="/assets/generated/icon-ai.dim_128x128.png"
            alt=""
          ...
          <div>
            ...
            <p className="page-subtitle">
              6 AI-powered tools to supercharge your agency
            </p>
          </div>
        </div>
      </div>
