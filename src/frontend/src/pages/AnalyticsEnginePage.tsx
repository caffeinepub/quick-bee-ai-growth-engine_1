    ...
    <div className="space-y-6">
      <div className="page-header">
        <div className="flex items-center gap-3">
          <img
            src="/assets/generated/icon-analytics.dim_128x128.png"
            alt=""
          ...
          <div>
            ...
            <p className="page-subtitle">
              GA4-style analytics reports and growth insights
            </p>
          </div>
        </div>
      </div>
      ...
      {simulated && data && (
        ...
        >
          ...
          <span className="text-xs" style={{ color: "#fbbf24" }}>
            Showing simulated data. Configure Automation Webhook URL for live
            data.
          </span>
        </div>
      )}
      ...
      {data && (
        <>
            ...
            <div className="glass-card rounded-xl p-5">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <LineChart data={data.sessionsTrend.slice(-14)}>
                  <CartesianGrid
                    strokeDasharray="3 3"
                    stroke="rgba(0,180,166,0.1)"
                  />
                  <XAxis
                    dataKey="date"
                    tick={{ fill: "rgba(232,245,244,0.4)", fontSize: 10 }}
            ...
            <div className="glass-card rounded-xl p-5">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={data.trafficSources}>
                  ...
                  <XAxis
                    dataKey="source"
                    tick={{ fill: "rgba(232,245,244,0.4)", fontSize: 9 }}
                  />
                  <YAxis
                    tick={{ fill: "rgba(232,245,244,0.4)", fontSize: 10 }}
                  />
          ...
          <div className="glass-card rounded-xl overflow-hidden">
            <div
              className="px-5 py-4"
              style={{ borderBottom: "1px solid rgba(0,180,166,0.15)" }}
            >
