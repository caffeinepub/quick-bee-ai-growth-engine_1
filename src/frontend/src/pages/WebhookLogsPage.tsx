...
import { CheckCircle, RefreshCw, Trash2, Webhook, XCircle } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={handleClear}
            className="border border-red-500/20 text-red-400/60 hover:text-red-400"
          >
      ...
      <div className="flex gap-3 flex-wrap">
        <Select value={toolFilter} onValueChange={setToolFilter}>
          ...
          >
            <SelectItem value="all" style={{ color: "#e8f5f4" }}>
              All Tools
            </SelectItem>
            {toolNames.map((name) => (
              <SelectItem key={name} value={name} style={{ color: "#e8f5f4" }}>
                {name}
              </SelectItem>
            ))}
          </SelectContent>
        ...
        <Select value={statusFilter} onValueChange={setStatusFilter}>
          ...
          >
            ...
            <SelectItem value="success" style={{ color: "#4ade80" }}>
              Success
            </SelectItem>
            <SelectItem value="error" style={{ color: "#f87171" }}>
              Error
            </SelectItem>
          </SelectContent>
        </Select>
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((log) => (
                  ...
                  >
                    ...
                    <td
                      className="px-4 py-3 max-w-xs truncate font-mono"
                      style={{ color: "#00b4a6" }}
                    >
                      {log.url}
                    </td>
                    ...
                    <td
                      ...
                      style={{ color: log.success ? "#4ade80" : "#f87171" }}
                    >
                      {log.statusCode || "—"}
                    </td>
                  </tr>
