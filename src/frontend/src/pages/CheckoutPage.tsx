      ...
      <div className="space-y-6">
        ...
        <div className="glass-card rounded-xl p-16 text-center">
          <ShoppingCart
            ...
            style={{ color: "rgba(0,180,166,0.3)" }}
          />
          ...
          >
            Browse our services catalog to add items.
          </p>
          <Button
    ...
    <div className="space-y-6 max-w-3xl">
      <div className="page-header">
        <div className="flex items-center gap-3">
          <img
            src="/assets/generated/icon-payment.dim_128x128.png"
            alt=""
        ...
        {items.map((item) => (
          ...
          >
            <div className="flex-1 min-w-0">
              ...
              >
                Tier:{" "}
                <span style={{ color: "#00d4c8" }}>{item.selectedTier}</span>
      ...
      <div className="glass-card rounded-xl p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-3xl font-bold teal-gradient-text">
        ...
        <Button
          ...
          disabled={loading || !hasRazorpay}
          className="w-full btn-teal text-base py-3"
        >
          {loading ? (
            "Processing..."
          ) : (
            <>
              ...
              {formatINR(grandTotal)} with Razorpay
            </>
          )}
        </Button>
      </div>
