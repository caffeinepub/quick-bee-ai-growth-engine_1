...
import {
  useClearExternalWebhookLogs,
  useGetExternalWebhookLogs,
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-white/50 text-sm mt-1">
            Receive and inspect data pushed from external tools
          </p>
        </div>
      ...
      <div className="glass-card rounded-xl p-4 border border-teal/20">
        ...
        <p className="text-xs text-white/50 mb-3">
          Configure your external tools (Zapier, Make, n8n, etc.) to POST data
          to this canister endpoint. Use the{" "}
          <code className="bg-white/10 px-1 rounded text-teal">
        ...
        <div className="mt-3 text-xs text-white/40 space-y-1">
          <p>
            • <strong className="text-white/60">toolName</strong>: Name of the
            sending tool (e.g., "Zapier")
          </p>
          <p>
            • <strong className="text-white/60">payload</strong>: JSON string or
            any text data
          </p>
          <p>
            • <strong className="text-white/60">source</strong>: Source
            identifier (e.g., "zapier-trigger-1")
          </p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 text-white/30">
          ...
          <p className="text-sm mt-1">
            Configure an external tool to send data to your endpoint
          </p>
        </div>
      ) : (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-teal/10">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-semibold text-white/40 uppercase tracking-wider w-10" />
                </tr>
              </thead>
              <tbody>
        ...
        <AlertDialogContent className="bg-[#0a1010] border border-teal/20 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-white/50">
              This will permanently delete all {logs.length} webhook log
