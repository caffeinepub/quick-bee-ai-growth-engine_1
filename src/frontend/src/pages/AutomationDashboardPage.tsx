...
function loadConfig(): AutomationConfig {
  try {
    ...
    if (stored) {
      ...
      return {
        whatsappAutoReply:
          parsed.whatsappAutoReply ?? defaultConfig.whatsappAutoReply,
        proposalSending:
          parsed.proposalSending ?? defaultConfig.proposalSending,
        leadFollowUp: parsed.leadFollowUp ?? defaultConfig.leadFollowUp,
        meetingScheduling:
          parsed.meetingScheduling ?? defaultConfig.meetingScheduling,
        paymentReminder:
          parsed.paymentReminder ?? defaultConfig.paymentReminder,
        dataSync: parsed.dataSync ?? defaultConfig.dataSync,
        analyticsReporting:
          parsed.analyticsReporting ?? defaultConfig.analyticsReporting,
        contentGeneration:
          parsed.contentGeneration ?? defaultConfig.contentGeneration,
      };
    }
  } catch {
    // ignore
...
const automations: {
...
}[] = [
  {
    ...
    description:
      "Automatically reply to WhatsApp messages from leads and clients.",
  ...
  },
  {
    ...
    description:
      "Auto-send proposals to qualified leads based on their requirements.",
  ...
  },
  {
    ...
    description:
      "Auto-schedule meetings and send calendar invites to prospects.",
  ...
  },
  {
    ...
    label: "Data Sync",
    description:
      "Keep all your data synchronized across platforms in real-time.",
  ...
  },
  {
    ...
    description:
      "AI-powered automatic content creation for social media and campaigns.",
