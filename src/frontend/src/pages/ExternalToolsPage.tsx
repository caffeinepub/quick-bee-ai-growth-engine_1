import { ArrowRight, Check, Copy, ExternalLink, Plug } from "lucide-react";
...
const TOOLS: Tool[] = [
  {
    ...
    description:
      "Connect 6,000+ apps and automate workflows without code. The most popular automation platform.",
    useCase:
      "Trigger posts when a new lead is added, sync CRM data, auto-log metrics from social platforms.",
  ...
  },
  {
    ...
    description:
      "Build complex multi-step automations with a visual drag-and-drop interface. More powerful than Zapier for complex flows.",
    useCase:
      "Create advanced workflows that pull social analytics and push them to your metrics dashboard.",
  ...
  },
  {
    ...
    description:
      "Self-hostable, open-source automation tool with 400+ integrations. Full control over your data.",
    useCase:
      "Self-host your automation pipeline, connect social APIs, and push data to your webhook endpoint.",
  ...
  },
  {
    ...
    description:
      "Schedule and publish posts across all major social platforms from one dashboard.",
    useCase:
      "Schedule posts planned in your Content Calendar and track engagement metrics.",
  ...
  },
  {
    ...
    description:
      "Manage all your social media accounts, schedule posts, and monitor performance in one place.",
    useCase:
      "Publish scheduled posts, monitor mentions, and export analytics to log in your metrics dashboard.",
  ...
  },
  {
    ...
    description:
      "Plan, schedule, and analyze your social media content with a visual calendar interface.",
    useCase:
      "Visually plan Instagram, TikTok, and Pinterest content aligned with your content calendar.",
  ...
  },
  {
    ...
    description:
      "Connect 1,000+ apps with unlimited workflows at a one-time price. Great Zapier alternative.",
    useCase:
      "Automate data collection from social platforms and push metrics to your dashboard via webhooks.",
  ...
  },
  {
    ...
    description:
      "Advanced social media management with deep analytics, team collaboration, and CRM integration.",
    useCase:
      "Export detailed analytics reports and log them in your metrics dashboard for cross-platform comparison.",
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="glass-card rounded-xl p-6 border border-teal/20">
        ...
        <div className="mb-4 flex items-center gap-2 bg-black/30 rounded-lg px-3 py-2 border border-teal/10">
          <code className="text-teal text-sm flex-1 break-all">
            {webhookUrl}
          </code>
          <button
            type="button"
