...
export function generateMockAnalytics(
  ...
  return {
    ...
    conversionRate: Number.parseFloat((2.4 + Math.random() * 2).toFixed(2)),
    sessionsTrend,
    trafficSources: [
      {
        source: "Organic Search",
        sessions: Math.floor(totalSessions * 0.38),
        percentage: 38,
      },
      {
        source: "Direct",
      ...
      {
        source: "Social Media",
        sessions: Math.floor(totalSessions * 0.18),
        percentage: 18,
      },
      {
        source: "Referral",
    ...
    topPages: [
      {
        path: "/services",
        views: Math.floor(totalSessions * 0.42),
        avgDuration: "3m 24s",
      },
      {
        path: "/",
        views: Math.floor(totalSessions * 0.35),
        avgDuration: "2m 10s",
      },
      {
        path: "/ai-tools",
        views: Math.floor(totalSessions * 0.28),
        avgDuration: "4m 52s",
      },
      {
        path: "/checkout",
      ...
      {
        path: "/leads",
        views: Math.floor(totalSessions * 0.12),
        avgDuration: "6m 03s",
      },
    ],
  };
