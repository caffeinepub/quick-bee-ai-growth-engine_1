...
const navItems = [
  ...
  { path: "/data-sync", label: "Cross-Device Sync", icon: RefreshCw },
];
...
export function AppSidebar() {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      {/* Logo */}
      <div
        className={`flex items-center gap-3 px-4 py-5 border-b border-teal/20 ${collapsed ? "justify-center" : ""}`}
      >
        <img
        ...
        {!collapsed && (
          <div>
            <div className="font-display font-bold text-sm teal-gradient-text leading-tight">
              Quick Bee
            </div>
            <div className="text-xs" style={{ color: "rgba(232,245,244,0.4)" }}>
              AI Growth Engine
            </div>
          </div>
        )}
