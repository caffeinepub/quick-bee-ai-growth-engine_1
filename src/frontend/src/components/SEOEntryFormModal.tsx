...
export function SEOEntryFormModal({
  open,
  onClose,
  entry,
  onSave,
}: SEOEntryFormModalProps) {
  ...
  return (
    ...
    >
      <DialogContent className="max-w-lg bg-[#0a1010] border border-teal/20 text-white">
        <DialogHeader>
          <DialogTitle className="text-teal">
            {entry ? "Edit SEO Entry" : "New SEO Entry"}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div>
            <Label className="text-white/70 text-xs mb-1 block">
              Meta Title
              <span
                className={`ml-2 text-xs ${metaTitle.length > 60 ? "text-red-400" : "text-white/30"}`}
              >
                {metaTitle.length}/60
              </span>
            </Label>
          ...
          <div>
            <Label className="text-white/70 text-xs mb-1 block">
              Meta Description
              <span
                className={`ml-2 text-xs ${metaDescription.length > 160 ? "text-red-400" : "text-white/30"}`}
              >
